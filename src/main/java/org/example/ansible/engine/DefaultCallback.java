...
public class DefaultCallback implements Callback {
    ...
    private final Set<Object> printedHeaders = Collections.newSetFromMap(new ConcurrentHashMap<>());
    ...
    public synchronized void v2_playbook_on_handler_stats(String handlerName) {
        if (printedHeaders.add("handler:" + handlerName)) {
            System.out.println();
