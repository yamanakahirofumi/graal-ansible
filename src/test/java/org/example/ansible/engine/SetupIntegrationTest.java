...
class SetupIntegrationTest {
    ...
    void testSetupModule() {
        ...
        // Check for some common facts
        assertTrue(facts.containsKey("ansible_os_family") || facts.containsKey("ansible_system"), "Should contain OS family or system fact");
        System.out.println("Collected facts: " + facts.keySet());
    }
}
