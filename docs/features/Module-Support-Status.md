...
| :--- | :---: | :---: | :---: | :--- |
| **ansible.builtin** | △ | ？ | ？ | Linux で 34/72 モジュール (実行成功 8, ロード成功 26) を確認済。 |
...
| - `stat` | ○ | ○ | - | ファイル情報取得の検証済。 |
| - `command` | ○ | ○ | - | オリジナルの Python 実装により検証済。 |
| - `shell` | ○ | ○ | - | オリジナルの Python 実装により検証済。 |
| - `setup` | ○ | ○ | - | オリジナルの Python 実装により検証済。 |
| - `lineinfile` | ○ | ○ | - | オリジナルの Python 実装により検証済。 |
| - `replace` | ○ | ○ | - | オリジナルの Python 実装により検証済。 |
