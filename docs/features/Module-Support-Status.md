...
| :--- | :---: | :---: | :---: | :--- |
| **ansible.builtin** | △ | ？ | ？ | Linux で 35/72 モジュール (実行成功 11, ロード成功 24) を確認済。 |
| - `debug` | ○ | ○ | ○ | オリジナル Python 実装および Java エミュレータの両方で検証済。 |
| - `ping` | ○ | ○ | - | 基本的な疎通確認テスト済。 |
| - `copy` | ○ | ○ | - | オリジナル Python 実装および Java エミュレータの両方で検証済。 |
| - `file` | ○ | ○ | - | ファイル状態管理の検証済。 |
| - `template` | ○ | ○ | - | オリジナル Python 実装および Java エミュレータの両方で検証済。 |
| - `stat` | ○ | ○ | - | ファイル情報取得の検証済。 |
| - `command` | ○ | ○ | - | オリジナル Python 実装による検証済。 |
| - `shell` | ○ | ○ | - | オリジナル Python 実装による検証済。 |
| - `setup` | ○ | ○ | - | オリジナル Python 実装による検証済。 |
| - `lineinfile` | ○ | ○ | - | オリジナル Python 実装による検証済。 |
| - `replace` | ○ | ○ | - | オリジナル Python 実装による検証済。 |
